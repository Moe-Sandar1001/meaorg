            ...
            <div class="">
                <div class=" ">
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active" style="padding-top: 115px">
                      <img src="{{asset('user/images/mon_banner1.jpg')}}" alt="Los Angeles" width="100%">
                    </div>
                    {{-- <div class="carousel-item">
                      <img src="{{asset('user/images/mon_banner.jpg')}}" alt="Chicago" width="100%">
                    </div>
                    <div class="carousel-item">
                      <img src="{{asset('user/images/mon_banner1.jpg')}}" alt="New York" width="100%">
                    </div> --}}
                  </div>
   ...
   <br><br>
    ...
    <section class="download-area section-padding">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    <div class="download-text" style="padding-left:14%;padding-right:0%">
                ...
                <div class="col-lg-6 pr-0">
                    <div class="download-img" style="background-size:cover;width:595px;height:345px;"></div>
                </div>
            </div>
        </div>
    </section>
